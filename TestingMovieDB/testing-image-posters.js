...
let outputHtml = "<h1>Hello</h1>";

outputHtml += "<ol>";

// Possibly better as GRID if I want to have the title below the image
topRated.results.map((movie, index) => {
  outputHtml += `<li><div class="number">${
    index + 1
  }</div><div><img src="https://image.tmdb.org/t/p/w185/${
    movie.poster_path
  }" alt="${movie.title} poster" title="${movie.title}" /></div></li>`;
});

outputHtml += "</ol>";

posterList.innerHTML = outputHtml;
