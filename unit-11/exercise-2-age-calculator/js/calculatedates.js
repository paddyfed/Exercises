function calculateCelebrityAge(dateOfBirth, dateOfDeath = null) {
  if (dateOfDeath === null) {
...
function calculateAgeInYearsAndDays(dateOfBirth, dateOfDeath = null) {
  if (dateOfDeath === null) {
    dateOfDeath = new Date();
  }
  dateOfDeath.setUTCHours(0, 0, 0, 0);
  ...
  const days = calculateCelebrityAge(intermediateDate, dateOfDeath);
